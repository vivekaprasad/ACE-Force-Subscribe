      ...
      try:
        ...
        try:
          sent_message = await message.reply_text(
              " {}You haven't joined Our Channel.\nපළමුව අපගේ ප්‍රධාන චැනලයට @BioVideoFullSyllubus සම්බන්ධ වී සිටින්න .චැනලයට Join වීමෙන් පසු Unmute Me යන Button එක Click කරන්න\nනැතහොත් ඔබව මෙම සමූහයෙන් ඉවත් කිරීමට සිදුවේ.".format(message.from_user.mention, channel, channel),
